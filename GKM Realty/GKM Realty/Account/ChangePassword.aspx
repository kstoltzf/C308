<%@ Page Title="Change Password" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false"
    CodeBehind="ChangePassword.aspx.vb" Inherits="GKM_Realty.ChangePassword" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p class="style2" 
        ...
        style="border: medium solid #000000; background-color: #C0C0C0; position: inherit; width: inherit; height: inherit;">
        <strong>Use the form below to change your password.
    </strong>
    </p>
    <asp:ChangePassword ID="ChangeUserPassword" runat="server" 
        CancelDestinationPageUrl="~/" EnableViewState="false" RenderOuterTable="false" 
         SuccessPageUrl="ChangePasswordSuccess.aspx" style="font-weight: 700">
        <ChangePasswordTemplate>
            ...
            <div class="accountInfo">
                <fieldset class="changePassword" 
                    ...
                    <legend class="style3"><strong style="padding: inherit; margin: inherit; font-size: large; background-color: #666666;">Account Information</strong></legend>
                    <p>
